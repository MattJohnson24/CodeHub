          ...
          <div className={styles.codeEditor}>
            ...
            <div id="codeEditorHeader" className={styles.codeEditorHeader}>
              <select className={styles.codeEditorHeaderLanguageSelection} name="" id="" onChange={handleSelectLanguage}>
                <option value="py" style={{color: "#000000"}}>Python</option>
                <option value="swift" style={{color: "#000000"}}>Swift</option>
                <option value="js" style={{color: "#000000"}}>Javascript</option>
                <option value="go" style={{color: "#000000"}}>Go</option>
